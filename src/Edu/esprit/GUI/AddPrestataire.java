 ...
 * @author Touch media
 */
public class AddPrestataire extends javax.swing.JFrame {
...
//        admin.setAdresse(txtf_adresse.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPrestataire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddPrestataire().setVisible(true);
            }
        });
    }
